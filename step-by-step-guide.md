...
>First and foremost we need to remember why we teach and who is our audience. We want to not only teach concepts as a total truth, but much more prepare our students for how they can read up on and learn more about the the topic later. The resources we use are almost without exception geared towards a Western audience, but we need to keep in mind that our students seldom have the same access to this as we do. So our goal is to: guide people towards the right resources and help them understand - but no excessive spoon-feeding of information. <p>
...
With all questions regarding the contents of the currciulum --> ask **Benjamin** :construction_worker:
...
You can also familiarise yourself with the pre-readings for the class and what students have learned so far by going through our [Copenhagen curriculum](https://github.com/HackYourFuture-CPH/curriculum). To ensure a smooth hand-over between modules there exists a dedicated mentor channel for each class, usually called "classXX-mentors" - here you can find and ask previous mentors about their teachings)<br>
For extra inspiration we can always check out the respective [Amsterdam repo](https://github.com/HackYourFuture/curriculum) corresponding to the module we are teaching.
...
3. **Schedule for the day.** <br> 
Experience shows that it’s a great help to show students an agenda for the day. Breaks should be honoured and kept to their intended length. We take short breaks every 45 minutes, as well as a long lunch break at 14:00 (ca.). Trying to adhere to this structure helps keeping focus and keeps energy up.

4. **Personal introduction.** <br>
When you start teaching a class, consider kicking it off by briefly explaining what kind of work you do, how you ended up in your job and how you use the frameworks we teach in your daily life. Experience shows that this isn't at all evident to many of our students, so it's a great motivation for them to get a real life, tangible example.

5. **Teaching techniques.** <br> 
Not everyone has teaching experience or a background in didactics, but don't fret. We try to always mix experienced teachers and new ones. It is of course an advantage to know how to convey knowledge well, but we try to model our classes after some uncontested didactic principles for the best results for learning: experiential learning (hands-on work) and peer-assisted learning (students helping one another).  
In practice this means that we try to use as few powerpoint slides as possible (ideally none) and focus on Live coding examples, group exercises and anything else that keeps people's hands on their keyboards and makes them apply their skills and practice them. Check out this repo for some more tips and tricks: [teaching_tips_and_tricks](https://github.com/HackYourFuture/teaching_tips_tricks).  
